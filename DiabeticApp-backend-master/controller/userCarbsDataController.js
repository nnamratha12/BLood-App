...
const storeUserData = (req, res) => {
  ...
  const mealDate = currentDate.toLocaleDateString("en-US");
...
// console.log("Blood", bloodGlucoseBeforeMeal );
...
//     console.log("req===>",req);
//     const { userId } = req.query;
// const {mealDate}= new Date().toLocaleDateString("en-GB");
// console.log("M===>", mealDate);
//     const userBloodGlucose = await userBloodGlucoseSchema.findOneAndUpdate({
//       userId,
//       mealDate,
//     });
